...
SQL maths empowers you to transform data to meet your specific needs, whether 
through fundamental arithmetic operators for scaling or by leveraging built-in 
functions for more complex calculations.

------------------------------------------------------------------------------------------------

/* Arithmetic Operators
In SQL, arithmetic operators perform mathematical operations on numeric values. 
These include addition (+), subtraction (-), multiplication (*), division (/), 
and modulus (%).

- You can use arithmetic operators with just numbers.
- You can use them to directly affect a column, such as giving a discount.
- They can also be used on the values of 2 columns.

*/

/*******************************************************************************
ROUND(): rounds a number to a specified number of decimal places.
FLOOR(): returns the largest integer that is less than or equal to a specified number (rounds down).
CEIL(): returns the smallest integer that is greater than or equal to a given number (rounds up).
ABS(): returns the absolute (positive) value of a number.
POW(): used to calculate the result of raising a number (base) to the power of another number (exponent).
*******************************************************************************/
